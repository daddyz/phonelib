...
Additional options:
  ...
  validates :attribute, phone: { default_country: 'CN', possible: true, allow_blank: true }

<tt>default_country: 'CN'</tt> - Set the default territory to China (territory names are {ISO 3166-1 Alpha-2}[http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2] codes)
